...
class SkillDetailDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.run_button.setObjectName("executeButton")
...
class ASKDesktopGUI(QMainWindow):
    ...
    def __init__(self):
        ...
        # Set window icon
        icon_path = Path(__file__).parent / "ask_icon.png"
        if icon_path.exists():
    ...
    def get_stylesheet() -> str:
        """Return the application stylesheet with dark theme and purple accents."""
        return """
        /* Main Application */
        QMainWindow {
